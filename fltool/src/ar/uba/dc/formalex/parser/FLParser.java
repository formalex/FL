...
/////////////////////////
  static final public void interval() throws ParseException {
    ...
    if (jj_2_31(3)) {
      ...
      jj_consume_token(SHARED_INTERVAL);
        anInterval.setShared();
    } else if (jj_2_33(3)) {
      jj_consume_token(GLOBAL_INTERVAL);
        anInterval.setGlobal();
    } else {
      jj_consume_token(-1);
      throw new ParseException();
    }
    ...
    if (jj_2_34(3)) {
      jj_consume_token(SHARED_ROLE_REFERENCE);
      jj_consume_token(IDENTIFIER);
          if (anInterval.isShared()) {
              anInterval.setRoleForInterval(getRole(token.image));
          } else {
              StringBuilder sb = new StringBuilder();
              sb.append("Error al definir el intervalo: ('" + anInterval.getName() + "'). Solo los intervalos shared pueden especificar rol.");
              {if (true) throw new RuntimeException(sb.toString());}
          }
    } else {
      ;
    }
      if (anInterval.isShared() && anInterval.getRoleForInterval() == null) {
          StringBuilder sb = new StringBuilder();
          sb.append("Se definio el intervalo compartido ('" + anInterval.getName() + "') sin especificar para que rol.");
          {if (true) throw new RuntimeException(sb.toString());}
      }
    ...
    if (jj_2_36(3)) {
      ...
      if (jj_2_35(3)) {
        jj_consume_token(SHARED_ROLE_SPECIFICITY);
                anInterval.addStartTriggerWithoutRefinement(startAction);
      } else {
        ;
      }
    } else {
    ...
    if (jj_2_41(3)) {
      ...
      if (jj_2_40(3)) {
        jj_consume_token(SHARED_ROLE_SPECIFICITY);
                anInterval.addEndTriggerWithoutRefinement(endAction);
      } else {
        ;
      }
    } else {
    ...
    if (jj_2_50(3)) {
      ...
      jj_consume_token(IDENTIFIER);
            if (counter.isShared()) {
                ...
                StringBuilder sb = new StringBuilder();
                sb.append("Error al definir el contador: ('" + counter.getName() + "'). Solo los contadores shared pueden especificar rol.");
                {if (true) throw new RuntimeException(sb.toString());}
            }
    } else {
      ;
        ...
        if (counter.isShared() && counter.getRoleForCounter() == null) {
            StringBuilder sb = new StringBuilder();
            sb.append("Se definio el contador compartido ('" + counter.getName() + "') sin especificar para que rol.");
            {if (true) throw new RuntimeException(sb.toString());}
        }
    if (jj_2_51(3)) {
  ...
  static final public void clause() throws ParseException {
    ...
    if (jj_2_80(3)) {
      //P-cláusula-disyuntiva       |   P-cláusula-conjuntiva |
        ...
        if(((Permission) p).isMandatory()) {
            flInput.addRule(((Permission) p).getMandatoryRule());
            flInput.addFLRule("Mandatory rule for: " + originalFormula);
        }
    } else if (jj_2_81(3)) {
      ...
      //EXISTS (var (: rol)? ; (O-cláusula-disyuntiva | F-cláusula-disyuntiva | P-cláusula-disyuntiva) ) |
        ...
        if (Util.hasPermission(p)){
            flInput.addPermission(p);
            flInput.addFLPermission(originalFormula);
            FLFormula qtyP = ((FLQuantifier)p).getMandatoryRuleForPermission();
            if(qtyP != null) {
                flInput.addRule(qtyP);
                flInput.addFLRule("Mandatory rule for: " + originalFormula);
            }
        }
        else{
...
//F-cláusula (AND F-cláusula)*
  ...
  originalFormula += "P(";
    ...
    if (conditionFormula == null)
    {
      ...
      res = new Permission(mainFormula, conditionFormula, mandatory);
    }
    originalFormula += ")";
    if (jj_2_112(3)) {
  ...
  static final public FLFormula terminal() throws ParseException {
    ...
    if (jj_2_163(3)) {
        ...
        ;
            ...
            if (counter != null){
                ...
                if (!tmp.isGlobal() & counter.getVariable() != null){
                    StringBuilder sb = new StringBuilder();
                    sb.append("En una f\u00f3rmula se hace referencia a un contador global o compartido usando agente: ('" + name + "').  " +
                        "Revisar datos del archivo de entrada, cerca de l\u00ednea: " + beginLine + ", columna: " + beginColumn);
                    {if (true) throw new RuntimeException(sb.toString());}
                }
      ...
      jj_consume_token(PAR_RIGHT);
            ...
            if (!tmp.isLocal() & interval.getVariable() != null){
                StringBuilder sb = new StringBuilder();
                sb.append("En una f\u00f3rmula se hace referencia a un intervalo global o compartido usando agente: ('" + name + "'). " +
                    "Revisar datos del archivo de entrada, cerca de l\u00ednea: " + beginLine + ", columna: " + beginColumn);
                {if (true) throw new RuntimeException(sb.toString());}
            }
  ...
  static private boolean jj_3_50() {
    if (jj_scan_token(SHARED_ROLE_REFERENCE)) return true;
    if (jj_scan_token(IDENTIFIER)) return true;
    return false;
  }
  ...
  static private boolean jj_3_32() {
    if (jj_scan_token(SHARED_INTERVAL)) return true;
    return false;
  }
  ...
  static private boolean jj_3_110() {
    if (jj_scan_token(ONLY_WHEN)) return true;
    if (jj_3R_58()) return true;
    return false;
  }
  ...
  static final private JJCalls[] jj_2_rtns = new JJCalls[167];
