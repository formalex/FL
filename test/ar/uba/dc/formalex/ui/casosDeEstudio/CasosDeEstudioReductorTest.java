...
public class CasosDeEstudioReductorTest extends FlTest {
	...
	public void testCasoDeEstudio1NroDeClausulas1WithIsHappening() throws Exception  {
		...
		TestUtils.corridaDeFormaLex(ROOT_CDE_REDUCTOR + "CasoDeEstudio1NroDeClausulas1WithIsHappening.txt", CON_MODEL_CHECKER, true);
	}
	
	@Test
	public void testCasoDeEstudio1NroDeClausulas5WithIsHappening() throws Exception  {
		
		TestUtils.corridaDeFormaLex(ROOT_CDE_REDUCTOR + "CasoDeEstudio1NroDeClausulas5WithIsHappening.txt", CON_MODEL_CHECKER, true);
	}
	
	@Test
	public void testCasoDeEstudio1NroDeClausulas15WithIsHappening() throws Exception  {
		
		TestUtils.corridaDeFormaLex(ROOT_CDE_REDUCTOR + "CasoDeEstudio1NroDeClausulas15WithIsHappening.txt", CON_MODEL_CHECKER, true);
	}
	...
	public void testCasoDeEstudio1NroDeClausulas60WithDefaultIsHappening() throws Exception  {
		...
		TestUtils.corridaDeFormaLex(FlTest.ROOT_CDE_FILTRADO + "CasoDeEstudio1NroDeClausulas60.txt", FlTest.CON_MODEL_CHECKER, true);
	}

	@Test
	public void testCasoDeEstudio2NroDeClausulas1WithIsHappening() throws Exception  {
		
		TestUtils.corridaDeFormaLex(ROOT_CDE_REDUCTOR + "CasoDeEstudio2NroDeClausulas1WithIsHappening.txt", CON_MODEL_CHECKER, true);
	}
	
	@Test
	public void testCasoDeEstudio2NroDeClausulas5WithIsHappening() throws Exception  {
		
		TestUtils.corridaDeFormaLex(ROOT_CDE_REDUCTOR + "CasoDeEstudio2NroDeClausulas5WithIsHappening.txt", CON_MODEL_CHECKER, true);
	}
	
	@Test
	public void testCasoDeEstudio2NroDeClausulas15WithIsHappening() throws Exception  {
		
		TestUtils.corridaDeFormaLex(ROOT_CDE_REDUCTOR + "CasoDeEstudio2NroDeClausulas15WithIsHappening.txt", CON_MODEL_CHECKER, true);
	}
	...
	public void testCasoDeEstudio2NroDeClausulas28WithDefaultIsHappening() throws Exception  {
		...
		TestUtils.corridaDeFormaLex(FlTest.ROOT_CDE_FILTRADO + "CasoDeEstudio2NroDeClausulas28.txt", FlTest.CON_MODEL_CHECKER, true);
	}
	
	@Test
	public void testCasoDeEstudio3NroDeClausulas1WithIsHappening() throws Exception  {
		
		TestUtils.corridaDeFormaLex(ROOT_CDE_REDUCTOR + "CasoDeEstudio3NroDeClausulas1WithIsHappening.txt", CON_MODEL_CHECKER, true);
	}
	
	@Test
	public void testCasoDeEstudio3NroDeClausulas5WithIsHappening() throws Exception  {
		
		TestUtils.corridaDeFormaLex(ROOT_CDE_REDUCTOR + "CasoDeEstudio3NroDeClausulas5WithIsHappening.txt", CON_MODEL_CHECKER, true);
	}
	
	@Test
	public void testCasoDeEstudio3NroDeClausulas15WithIsHappening() throws Exception  {
		
		TestUtils.corridaDeFormaLex(ROOT_CDE_REDUCTOR + "CasoDeEstudio3NroDeClausulas15WithIsHappening.txt", CON_MODEL_CHECKER, true);
	}
	...
	public void testCasoDeEstudio3NroDeClausulas32WithDefaultIsHappening() throws Exception  {
		...
		TestUtils.corridaDeFormaLex(FlTest.ROOT_CDE_FILTRADO + "CasoDeEstudio3NroDeClausulas32.txt", FlTest.CON_MODEL_CHECKER, true);
	}
}
